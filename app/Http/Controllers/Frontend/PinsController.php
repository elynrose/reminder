...
class PinsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.pins.index', compact('pins'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.pins.create', compact('locations', 'reminders'));
    }
    ...
    public function store(StorePinRequest $request)
    {
        ...
        return redirect()->route('frontend.pins.index');
    }
    ...
    public function edit(Pin $pin)
    {
        ...
        return view('frontend.pins.edit', compact('locations', 'pin', 'reminders'));
    }
    ...
    public function show(Pin $pin)
    {
        ...
        return view('frontend.pins.show', compact('pin'));
    }
