                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.locations.update", [$location->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gname" id="gname" value="{{ old('gname', $location->gname) }}">
                            @if($errors->has('gname'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('gname') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="lat" id="lat" value="{{ old('lat', $location->lat) }}" step="0.0000001">
                            @if($errors->has('lat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lat') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="lng" id="lng" value="{{ old('lng', $location->lng) }}" step="0.0000001">
                            @if($errors->has('lng'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lng') }}
                                </div>
...
<script>
    ...
    url: '{{ route('frontend.locations.storeMedia') }}',
    maxFilesize: 2, // MB
