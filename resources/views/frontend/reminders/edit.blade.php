                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.reminders.update", [$reminder->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $reminder->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="due_date" id="due_date" value="{{ old('due_date', $reminder->due_date) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="notify_me" id="notify_me" value="1" {{ $reminder->notify_me || old('notify_me', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="completed" id="completed" value="1" {{ $reminder->completed || old('completed', 0) === 1 ? 'checked' : '' }}>
