                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('reminder_access')
                                        <a class="dropdown-item" href="{{ route('frontend.reminders.index') }}">
                                            {{ trans('cruds.reminder.title') }}
                                        </a>
                                    @endcan
                                    @can('location_access')
                                        <a class="dropdown-item" href="{{ route('frontend.locations.index') }}">
                                    ...
                                    @endcan
                                    @can('pin_access')
                                        <a class="dropdown-item" href="{{ route('frontend.pins.index') }}">
                                            {{ trans('cruds.pin.title') }}
                                        </a>
                                    @endcan
